...
| Medium                | JetNews     | ✅      | Phone-only Home / Article / Interests, drawer, bookmarks, bundled hero PNGs, adaptive Topics layout, theme/resource polish, live search filtering, clickable article links, refresh/retry, snackbar feedback and share chooser. Navigation 3 list/detail, shared transitions, inbound deep links and Glance remain deferred. See [JetNews](JetNews/README.md). |
