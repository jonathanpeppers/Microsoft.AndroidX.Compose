...
{
    ("androidx.compose.animation",  "animation",                                    "1.11.3", "animation"),
    ("androidx.compose.animation",  "animation-android",                            "1.11.3", "animation"),
    ("androidx.compose.animation",  "animation-core",                               "1.11.3", "animation-core"),
    ("androidx.compose.animation",  "animation-core-android",                       "1.11.3", "animation-core"),
    ("androidx.compose.foundation", "foundation",                                   "1.11.3", "foundation"),
    ("androidx.compose.foundation", "foundation-android",                           "1.11.3", "foundation"),
    ("androidx.compose.foundation", "foundation-layout",                            "1.11.3", "foundation-layout"),
    ("androidx.compose.foundation", "foundation-layout-android",                    "1.11.3", "foundation-layout"),
    ("androidx.compose.material3",  "material3",                                    "1.4.0",  "material3"),
    ("androidx.compose.material3",  "material3-android",                            "1.4.0",  "material3"),
    ("androidx.compose.material3",  "material3-adaptive-navigation-suite",          "1.4.0",  "material3-adaptive-navigation-suite"),
    ("androidx.compose.material3",  "material3-adaptive-navigation-suite-android",  "1.4.0",  "material3-adaptive-navigation-suite"),
    ("androidx.compose.runtime",    "runtime",                                      "1.11.3", "runtime"),
    ("androidx.compose.runtime",    "runtime-android",                              "1.11.3", "runtime"),
    ("androidx.compose.runtime",    "runtime-saveable",                             "1.11.3", "runtime-saveable"),
    ("androidx.compose.runtime",    "runtime-saveable-android",                     "1.11.3", "runtime-saveable"),
    ("androidx.compose.ui",         "ui",                                           "1.11.3", "ui"),
    ("androidx.compose.ui",         "ui-android",                                   "1.11.3", "ui"),
    ("androidx.compose.ui",         "ui-graphics",                                  "1.11.3", "ui-graphics"),
    ("androidx.compose.ui",         "ui-graphics-android",                          "1.11.3", "ui-graphics"),
    ("androidx.compose.ui",         "ui-text",                                      "1.11.3", "ui-text"),
    ("androidx.compose.ui",         "ui-text-android",                              "1.11.3", "ui-text"),
    ("androidx.compose.ui",         "ui-unit",                                      "1.11.3", "ui-unit"),
    ("androidx.compose.ui",         "ui-unit-android",                              "1.11.3", "ui-unit"),
