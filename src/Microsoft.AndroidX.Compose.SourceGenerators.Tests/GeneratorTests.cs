...
public class GeneratorTests
{
    ...
    public void HappyPath_EmitsNamedBitsAndAll()
    {
        var bindings = """
            ...
            """;
        var attr = """
            [assembly: AndroidX.Compose.ComposeDefaults<Foo.FooKt>("Foo", "FooDefault")]
            """;
    ...
    public void FunctionTypedParameters_AreSkipped_HolesPreserved()
    {
        var bindings = """
            ...
            """;
        var attr = """
            [assembly: AndroidX.Compose.ComposeDefaults<Foo.ButtonKt>("Button", "ButtonDefault")]
            """;
    ...
    public void MangledKotlinName_IsResolvedByExactString()
    {
        var bindings = """
            ...
            """;
        var attr = """
            [assembly: AndroidX.Compose.ComposeDefaults<Foo.TextKt>("TextDashDashFoo", "TextDefault")]
            """;
    ...
    {
        var attr = """
            [assembly: AndroidX.Compose.ComposeDefaults("ButtonDefault",
    ...
    public void DeclarativeAttribute_RequiresNoBindingSymbols()
    {
        ...
        var attr = """
            [assembly: AndroidX.Compose.ComposeDefaults("FooDefault", "alpha", "beta", "gamma")]
            """;
    ...
    static string BuildDeclarativeAttribute(string enumName, int slotCount)
    {
        ...
        return $"[assembly: AndroidX.Compose.ComposeDefaults(\"{enumName}\", {names})]";
    }
    ...
    public void SmallEnum_GoldenStringUnchangedFromPreIssue178()
    {
        ...
        var attr = """
            [assembly: AndroidX.Compose.ComposeDefaults("SmallDefault", "alpha", "beta", "gamma")]
            """;
        ...
        var expected =
            "// <auto-generated/>\n" +
            "// Generated by AndroidX.Compose.SourceGenerators from declarative names for 'SmallDefault'\n" +
    ...
    public void Split_RoundTripsThroughGeneratedHelper()
    {
        ...
        var enumType = asm.GetType("AndroidX.Compose.RoundTripDefault");
        Assert.NotNull(enumType);
        Assert.Equal(typeof(long), System.Enum.GetUnderlyingType(enumType!));

        var extType = asm.GetType("AndroidX.Compose.RoundTripDefaultExtensions");
