...
public class GeneratorTests
{
            ...
            namespace Foo
            {
                public static class FooKt
                {
                    public static void Foo(int alpha, string beta,
                        global::AndroidX.Compose.Runtime.IComposer _composer, int _changed, int _default) { }
                }
            }
            """;
        var attr = """
            [assembly: Microsoft.AndroidX.Compose.ComposeDefaults<Foo.FooKt>("Foo", "FooDefault")]
            """;
    ...
    public void FunctionTypedParameters_AreSkipped_HolesPreserved()
    {
        var bindings = """
            ...
            """;
        var attr = """
            [assembly: Microsoft.AndroidX.Compose.ComposeDefaults<Foo.ButtonKt>("Button", "ButtonDefault")]
            """;
            ...
            namespace Foo
            {
                public static class TextKt
                {
                    public static void TextDashDashFoo(string text, int alpha,
                        global::AndroidX.Compose.Runtime.IComposer _composer, int _changed) { }
                }
            }
            """;
        var attr = """
            [assembly: Microsoft.AndroidX.Compose.ComposeDefaults<Foo.TextKt>("TextDashDashFoo", "TextDefault")]
            """;
    ...
    {
        var attr = """
            [assembly: Microsoft.AndroidX.Compose.ComposeDefaults("ButtonDefault",
    ...
    public void DeclarativeAttribute_RequiresNoBindingSymbols()
    {
        ...
        var attr = """
            [assembly: Microsoft.AndroidX.Compose.ComposeDefaults("FooDefault", "alpha", "beta", "gamma")]
            """;
    ...
    static string BuildDeclarativeAttribute(string enumName, int slotCount)
    {
        ...
        return $"[assembly: Microsoft.AndroidX.Compose.ComposeDefaults(\"{enumName}\", {names})]";
    }
    ...
    public void SmallEnum_GoldenStringUnchangedFromPreIssue178()
    {
        ...
        var attr = """
            [assembly: Microsoft.AndroidX.Compose.ComposeDefaults("SmallDefault", "alpha", "beta", "gamma")]
            """;
        ...
        var expected =
            "// <auto-generated/>\n" +
            "// Generated by Microsoft.AndroidX.Compose.SourceGenerators from declarative names for 'SmallDefault'\n" +
    ...
    public void Split_RoundTripsThroughGeneratedHelper()
    {
        ...
        var enumType = asm.GetType("Microsoft.AndroidX.Compose.RoundTripDefault");
        Assert.NotNull(enumType);
        Assert.Equal(typeof(long), System.Enum.GetUnderlyingType(enumType!));

        var extType = asm.GetType("Microsoft.AndroidX.Compose.RoundTripDefaultExtensions");
