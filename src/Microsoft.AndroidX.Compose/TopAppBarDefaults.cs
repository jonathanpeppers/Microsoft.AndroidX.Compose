...
/// <see cref="ComposeRuntime.Remember{T}(Func{T}, int, string)"/>
...
/// types directly — there's no Microsoft.AndroidX.Compose wrapper because the
...
/// Canonical usage:
/// <code>
/// var state = ComposeRuntime.Remember(() =&gt;
...
public static class TopAppBarDefaults
{
    ...
    /// via <see cref="ComposeRuntime.Remember{T}(Func{T}, int, string)"/>.
    /// </param>
