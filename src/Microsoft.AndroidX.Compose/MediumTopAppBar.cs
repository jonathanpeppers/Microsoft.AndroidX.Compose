...
/// progresses. Same slots as <see cref="TopAppBar"/>. Typically paired
/// with <see cref="TopAppBarDefaults.ExitUntilCollapsedScrollBehavior(AndroidX.Compose.Material3.TopAppBarState, int, string)"/>
