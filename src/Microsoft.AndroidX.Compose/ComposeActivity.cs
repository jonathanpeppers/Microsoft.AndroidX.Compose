...
/// <summary>
/// Base activity for Microsoft.AndroidX.Compose apps. Mirrors the Kotlin shape:
...
public abstract class ComposeActivity : ComponentActivity
{
    ...
    ///
    /// Forwards to <see cref="ComposeRuntime.Remember{T}(Func{T}, int, string)"/>,
    ...
    protected T Remember<T>(
        ...
        => ComposeRuntime.Remember(factory, line, file);

    /// <summary>Keyed <c>remember(key1) { factory() }</c>; forwards to <see cref="ComposeRuntime.Remember{T}(Func{T}, object?, int, string)"/>.</summary>
    protected T Remember<T>(
        Func<T> factory,
        object? key1,
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.Remember(factory, key1, line, file);
    ...
    protected T Remember<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.Remember(factory, key1, key2, line, file);
    ...
    protected T Remember<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.Remember(factory, key1, key2, key3, line, file);
    ...
    protected T RememberKeyed<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.RememberKeyed(factory, keys, line, file);
    ...
    /// See <see cref="ComposeRuntime.RememberSaveable{T}(Func{T}, int, string)"/>
    ...
    protected T RememberSaveable<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.RememberSaveable(factory, line, file);

    /// <summary>Keyed <c>rememberSaveable(key1) { factory() }</c>; forwards to <see cref="ComposeRuntime.RememberSaveable{T}(Func{T}, object?, int, string)"/>.</summary>
    protected T RememberSaveable<T>(
        Func<T> factory,
        object? key1,
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.RememberSaveable(factory, key1, line, file);
    ...
    protected T RememberSaveable<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.RememberSaveable(factory, key1, key2, line, file);
    ...
    protected T RememberSaveable<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.RememberSaveable(factory, key1, key2, key3, line, file);
    ...
    protected T RememberSaveableKeyed<T>(
        ...
        [CallerLineNumber] int line = 0,
        [CallerFilePath]   string file = "")
        => ComposeRuntime.RememberSaveableKeyed(factory, keys, line, file);
