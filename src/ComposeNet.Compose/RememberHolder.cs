...
/// <see cref="Compose.Remember{T}(Func{T}, int, string)"/> store an arbitrary managed
...
///
/// When a keyed <see cref="Compose.Remember{T}(Func{T}, object?, int, string)"/> overload is used,
