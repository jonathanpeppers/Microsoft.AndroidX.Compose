...
internal static partial class ComposeBridges
{
    ...
    [ComposeFacade(Summary = "Material 3 Text composable.")]
    ...
    [ComposeFacade(Summary = "Material 3 filled Button. Constructor takes an onClick; content comes from collection-initializer children: new Button(onClick: () => count++) { new Text(\"Tap\") }.")]
    ...
    [ComposeBridge(
        ...
        Signature = "(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/Modifier;Z" +
                    ...
                    "Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;II)V",
        Defaults  = typeof(ButtonDefault))]
    [ComposeFacade(Summary = "Material 3 OutlinedButton. Same shape as Button.")]
    ...
    [ComposeBridge(
        ...
        Signature = "(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/Modifier;Z" +
                    ...
                    "Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;II)V",
        Defaults  = typeof(ButtonDefault))]
    [ComposeFacade(Summary = "Material 3 TextButton. Same shape as Button.")]
    ...
    [ComposeBridge(
        ...
        Signature = "(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/Modifier;Z" +
                    ...
                    "Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;II)V",
        Defaults  = typeof(ButtonDefault))]
    [ComposeFacade(Summary = "Material 3 ElevatedButton. Same shape as Button.")]
    ...
    [ComposeBridge(
        ...
        Signature = "(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/Modifier;Z" +
                    ...
                    "Lkotlin/jvm/functions/Function3;Landroidx/compose/runtime/Composer;II)V",
        Defaults  = typeof(ButtonDefault))]
    [ComposeFacade(Summary = "Material 3 FilledTonalButton. Same shape as Button.")]
    ...
    [ComposeFacade(Summary = "Material 3 IconButton. Children render into a Function2 content slot (no RowScope). Typical use: new IconButton(...) { new Text(\"☆\") }.")]
    ...
    [ComposeFacade(Summary = "Material 3 FilledIconButton. Same shape as IconButton.")]
    ...
    [ComposeBridge(
        ...
        Signature = "(Lkotlin/jvm/functions/Function0;Landroidx/compose/ui/Modifier;Z" +
                    ...
                    "Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/Composer;II)V",
        Defaults  = typeof(FilledIconButtonDefault))]
    [ComposeFacade(Summary = "Material 3 FilledTonalIconButton. Same shape as IconButton.")]
    ...
    [ComposeFacade(Summary = "Material 3 OutlinedIconButton. Same shape as IconButton.")]
    ...
    [ComposeFacade(Summary = "Material 3 FloatingActionButton.")]
    ...
    [ComposeFacade(Summary = "Material 3 non-interactive Surface. Applies background color, elevation, and clipping to its content.")]
    ...
    [ComposeFacade(Summary = "Material 3 non-clickable Card — a tonal surface with rounded corners that lays its children out as a Column. Children are added via collection-initializer syntax.")]
    ...
    [ComposeBridge(
        ...
        Signature = CardSig,
        Defaults  = typeof(CardDefault))]
    [ComposeFacade(Summary = "Material 3 OutlinedCard — a card surrounded by a thin outline instead of relying on tonal/shadow elevation for separation.")]
    ...
    [ComposeFacade(Summary = "Material 3 ElevatedCard — like Card but uses shadow rather than tonal elevation for separation. Children are added via collection-initializer syntax.")]
    ...
    [ComposeFacade(Scope = "Row", Summary = "Material 3 NavigationBar. Container for NavigationBarItem children laid out horizontally; the RowScope receiver is published via RenderContext so child NavigationBarItems can pass it to their RowScope-extension static.")]
    ...
    [ComposeFacade(Scope = "Row", Summary = "Material 3 Badge. A small colored marker, typically dropped inside a BadgedBox.Badge slot. Children are the badge content (usually a count), laid out in a RowScope. Pass no children for a plain dot.")]
